...
# model_config = api_configs.get('kimi')
...
# reasoner_rag = SelfRefineRagModule(module_path=module_path,files_path=files_path,collection_name=collection_name,is_upload_file=True)

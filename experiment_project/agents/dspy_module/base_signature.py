...
def init_costar_signature(role: Union[str, None] = None, backstory: Union[str, None] = None, output_fields: dict = None, input_fields: list[str] = None,objective:str=None,specifics:str=None,actions:str=None,results:str=None,example:str=None):
    """
    Context（上下文）: 提供任务的背景信息。
    ...
    """
    inputs = {}
    # objective: str = None, specifics:str = None, actions:str = None, results:str = None,
    # inputs = {'role': role, 'backstory': backstory,}
    for input_field in [role,backstory,objective,specifics,actions,results,example]:

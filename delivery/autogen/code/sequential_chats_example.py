...
yi_llm_config = {"model": "yi-34b-chat-0205", "api_key": '',"base_url":"https://api.lingyiwanwu.com/v1"}
openai_llm_config = {"model": "gpt-4", "api_key": ''}
zhipu_llm_config = {"model": "glm-4", "api_key": '','base_url':'https://open.bigmodel.cn/api/paas/v4'}
deepseek_llm_config = {"model": "deepseek-chat", "api_key": '','base_url':'https://api.deepseek.com/v1'}
